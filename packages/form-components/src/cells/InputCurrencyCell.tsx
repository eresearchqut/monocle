...
import {CellProps, isIntegerControl, isNumberControl, optionIs, or, RankedTester, rankWith} from '@jsonforms/core';
...
export const InputCurrencyCell = (props: CellProps) => {
    ...
    const {groupNumbers, step, decimalPlaces, focus, currencyCode, currencyDisplay} = merge({}, config, uischema.options) as InputCurrencyCellOptions;
