...
import {
    HorizontalLayout, JsonFormsCellRendererRegistryEntry, JsonFormsRendererRegistryEntry,
    JsonSchema,
    LayoutProps,
    RankedTester,
    rankWith,
...
const renderChildren = (layout: HorizontalLayout,
                        schema: JsonSchema,
                        path: string,
...
const HorizontalLayoutRenderer: FunctionComponent<LayoutProps> = (
    ...
    return (
        <div className="p-grid p-fluid">
            {renderChildren(horizontalLayout, schema, path, renderers, cells)}
        </div>
    );
};
