...
const AnyOfRenderer = ({
  ...
  return (
    <JsonFormsDispatch schema={inputSchema} uischema={inputUischema} path={path} renderers={renderers} cells={cells} />
  );
};

export const anyOfLayoutTester: RankedTester = rankWith(3, isAnyOfControl);
// @ts-ignore
