...
export class UserService {
    ...
    public addRoleToGroup(tenant_id: string, application_id: string, role_id: string, group_id: string) {
       return this.addAssociation(tenant_id, application_id, role_id, RBAC_ROLE_PREFIX, group_id, RBAC_GROUP_PREFIX);
    }
    ...
    public getUserRoles(tenant_id: string, application_id: string, user_id: string): Promise<string[]> {
        return this.getAssociations(tenant_id, application_id, user_id, RBAC_USER_PREFIX, RBAC_ROLE_PREFIX);
    }
    ...
    // /**
    //  * Get  the user in a role for the application and tenant
    //  * @param tenant_id
    //  * @param application_id
    //  * @param role_id
    //  */
    // public getUser(tenant_id: string, application_id: string, role_id: string) {
    //     const command = new QueryCommand({
    //         TableName: this.rbacTableName,
    //         KeyConditionExpression: '#pk = :pk and begins_with(#sk, :skPrefix)',
    //         ExpressionAttributeNames: {
    ...
    //         },
    //         ExpressionAttributeValues: marshall({
    //             ':pk': `${tenant_id}:${application_id}:${role_id}`,
    //             ':skPrefix': RBAC_SK_USER_PREFIX
    //         })
    //     } as QueryCommandInput)
    //
    //
